# -*- coding: utf-8 -*-
"""
Created on Tue Apr 10 11:48:33 2018
"""
...
train_dir, validation_dir, test_dir, nb_train_samples, nb_validation_samples,nb_test_samples = \
                    utils.preapare_full_dataset_for_flow(
                            ...
                            target_base_dir='D:\\Data-Science\\Distracted Driver\\bottle_neck_target')

model = applications.VGG16(include_top=False, weights='imagenet', 
                           input_shape=(img_width, img_height, 3))

bottleneck_dir = 'D:\\Data-Science\\Distracted Driver\\bottleneck_features'
...
if(os.getcwd() == "D:\\Data-Science\\Distracted Driver"):
    os.chdir("D:/Data-Science/Distracted Driver/bottleneck_features")

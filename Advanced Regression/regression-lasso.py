...
#L1 regulizer/Lasso
#Regulizers will assign zeros to un-important fetures
...
#0.194408382164
#0.19270196310743642
#Here you can see some of the coefficients as Zero and such fetures will be eliminated while predicting.
coef = model.coef_ #Weights of all the features (w1, w2, w3.....)
dir(coef.tolist)
intercept = model.intercept_ #W0, minimal value
